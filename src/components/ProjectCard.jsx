  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: `radial-gradient(220px circle at ${pos.x}px ${pos.y}px, rgba(99,102,241,0.12), transparent 60%)` }}
      />
      <div className="mb-3 flex flex-wrap gap-2">
        {tech.map((t, i) => (
          <span
            ...
            style={{
              background: `var(--badge-bg, ${i % 2 === 0 ? '#e0f2fe' : '#fef9c3'})`,
      ...
      <p className="mt-1 text-sm" style={{ color: "var(--desc-text)" }}>{desc}</p>
      <div className="mt-4 inline-flex items-center gap-1 text-sm font-medium">
        View <ExternalLink size={16} className="transition-transform group-hover:translate-x-0.5" />
      </div>
    </Motion.a>
  )
}
