  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-5 py-3 flex items-center justify-between relative">
        ...
        >
          <a href="#projects" className="hover:opacity-80">Projekti</a>
          <a href="#experience" className="hover:opacity-80">Izkušnje</a>
          <a href="#education" className="hover:opacity-80">Izobraževanje</a>
          <a href="#about" className="hover:opacity-80">O meni</a>
          <a href="#contact" className="hover:opacity-80">Kontakt</a>
        </nav>
        <div className="flex items-center gap-4">
          ...
          <a aria-label="Email" href={LINKS.email} className="rounded-lg border p-2 hover:bg-neutral-50 dark:hover:bg-neutral-800"><Mail size={18}/></a>
          <ThemeToggle/>
        </div>
      </div>
    </header>
