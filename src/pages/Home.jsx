  ...
  return (
    <div className="antialiased" style={{ background: "var(--bg)", color: "var(--text)" }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--section-gap)' }}>
        ...
        <Section id="experience" eyebrow="Work Experience" title="Experience" right={<Briefcase size={18} className="opacity-70" />}>
          <Reveal>
            <ol className="relative border-s pl-6">
              <li className="mb-8">
                ...
                <div className="text-base font-semibold">Internship & Summer Student Work</div>
                ...
                <ul className="list-disc pl-5 text-sm mt-2" style={{ color: 'var(--desc-text)' }}>
                  ...
                  <li>Basic work with PLCs and controller software</li>
                </ul>
              </li>
            </ol>
          </Reveal>
        ...
        <Section id="education" eyebrow="Education" title="Education" right={<GraduationCap size={18} className="opacity-70" />}>
          <Reveal>
            <ol className="relative border-s pl-6">
              <li className="mb-8">
                <span className="absolute -start-[9px] mt-1.5 h-4 w-4 rounded-full border bg-white dark:bg-neutral-900" style={{ background: "var(--card)" }}/>
                <div className="text-xs uppercase tracking-wide font-semibold" style={{ color: "var(--text-secondary)" }}>2024 – Present</div>
                <div className="text-base font-semibold">Computer and Information Science Engineer</div>
                <div className="text-sm mt-1 font-medium">School Centre Kranj</div>
                <div className="text-xs mt-1">Website <a href="https://www.sckr.si" className="underline">www.sckr.si</a> | EQF Level 6</div>
              </li>
              <li>
                <span className="absolute -start-[9px] mt-1.5 h-4 w-4 rounded-full border bg-white dark:bg-neutral-900" style={{ background: "var(--card)" }}/>
                ...
                <div className="text-xs mt-1">Website <a href="https://www.vegova.si" className="underline">www.vegova.si</a> | EQF Level 5</div>
              </li>
            </ol>
          </Reveal>
        </Section>
        ...
        <div className="flex flex-col gap-4">
          <Section id="about" eyebrow="About Me" title="About Me" right={<User size={18} className="opacity-70" />}>
            <Reveal>
              <div className="grid items-stretch gap-4 md:grid-cols-[1fr_1.2fr]">
                ...
                <div className="rounded-2xl border p-6 flex flex-col h-full">
                  ...
                  <ul className="list-disc pl-5 text-sm" style={{ color: 'var(--desc-text)' }}>
                    ...
                    <li>Advanced Windows and MS Office skills</li>
